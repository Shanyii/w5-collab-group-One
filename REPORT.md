<img width="865" height="277" alt="image" src="https://github.com/user-attachments/assets/21670b86-5ec5-4759-a597-b4c2b3c7b158" /># W5 PR 協作練習 — 作業報告
...
| Chingen-Shen | `mamber-b` | 新增清除對話按鈕功能 | [PR #1](https://github.com/Shanyii/w5-collab-group-One/pull/1) | ✅ |
| （組員 C） | `member-c` | 在 header 下方加字數統計 | （填入 PR 連結） | ❌ |
| 黃柏豪 | `member-d` | 在 header 加深色模式切換按鈕 | (https://github.com/Shanyii/w5-collab-group-One/pull/4) | ✅ |
| （組員 E） | `member-e` | 在 footer 加鍵盤快捷鍵說明 | （填入 PR 連結） | ❌ |
